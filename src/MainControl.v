module MainControl(input wire [5:0] opcode, output wire RegDst, output wire RegSrc,output wire ExtOp, output wire RegW, output wire ALUSrc, output wire MemRd, output wire MemWr, output wire [1:0] Wbdata);
